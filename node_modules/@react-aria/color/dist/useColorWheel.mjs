import {useGlobalListeners as $hcgPp$useGlobalListeners, focusWithoutScrolling as $hcgPp$focusWithoutScrolling, useFormReset as $hcgPp$useFormReset, mergeProps as $hcgPp$mergeProps, useLabels as $hcgPp$useLabels, getEventTarget as $hcgPp$getEventTarget} from "@react-aria/utils";
...
function $b4a0a4fdc900495e$export$9064ff4e44b3729a(props, state, inputRef) {
    ...
    return {
        ...
        inputProps: (0, $hcgPp$mergeProps)(inputLabellingProps, {
            ...
            form: form,
            onChange: (e)=>{
                state.setHue(parseFloat((0, $hcgPp$getEventTarget)(e).value));
            },
